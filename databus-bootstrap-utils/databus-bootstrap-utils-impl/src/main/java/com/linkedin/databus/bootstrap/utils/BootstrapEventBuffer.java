...
public class BootstrapEventBuffer implements DbusEventBufferAppendable, DbusEventBufferStreamAppendable
{
	...
	public static class EventBufferEntry
	{
		...
		public EventBufferEntry()
		{

		}

		public EventBufferEntry(DbusEventKey key,
		...
		public String toString() {
			return "EventBufferEntry [type=" + type + ", key=" + key
					+ ", seederChunkKey=" + seederChunkKey + ", pPartitionId="
					+ pPartitionId + ", lPartitionId=" + lPartitionId
					+ ", timeStamp=" + timeStamp + ", srcId=" + srcId
					+ ", schemaId=" + Arrays.toString(schemaId) + ", value="
					+ Arrays.toString(value) + ", enableTracing="
					+ enableTracing + ", statsCollector=" + statsCollector
					+ "]";
		}		
	}
			...
			DbusEventsStatisticsCollector statsCollector)
	{
		...
		entry.reset(key,
				...
				eventInfo.getValue(), eventInfo.isEnableTracing(), statsCollector);
