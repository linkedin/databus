...
public class BufferPositionParser
{
  ...
  private long _offsetMask;
  private long _indexMask;
  private long _genIdMask;
  private int  _offsetShift;
  private int  _indexShift;
  private int  _genIdShift;

  private long _totalBufferSize;
  ...
  */
  ...
  {
      long newPosition = ((long)bufferGenId(position)) << _genIdShift;
  ...
  {
    long index =  ((long)(position & _indexMask) >> _indexShift);
    return (int) index;
  }
  ...
  {
    int offset = (int) ((long)(position & _offsetMask) >> _offsetShift);
    return offset;
  }
  ...
  {
    long genId =  ((long)(position & _genIdMask) >> _genIdShift);
    return genId;  
  }
