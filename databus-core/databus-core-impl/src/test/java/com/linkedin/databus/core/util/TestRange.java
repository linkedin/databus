...
public class TestRange {
	...
	public void testToString() {
	     ...
	     String exp = "{start:[GenId=0;Index=0;Offset=1] - end:[GenId=0;Index=0;Offset=100]}";
	     AssertJUnit.assertEquals("Range ToString", exp,r1.toString(parser));

	     r1 = new Range(0, Integer.MAX_VALUE);
	     exp = "{start:[GenId=0;Index=0;Offset=0] - end:[GenId=0;Index=0;Offset=2147483647]}";
	     AssertJUnit.assertEquals("Range ToString", exp,r1.toString(parser));

	     r1 = new Range(0, Long.MAX_VALUE);
	     exp = "{start:[GenId=0;Index=0;Offset=0] - end:[GenId=1;Index=2147483647;Offset=2147483647]}";
	     AssertJUnit.assertEquals("Range ToString", exp,r1.toString(parser));
	}
}
