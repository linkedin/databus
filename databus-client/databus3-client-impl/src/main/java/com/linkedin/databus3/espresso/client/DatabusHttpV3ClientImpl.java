    ...
    implements DatabusV3Client, DatabusExternalViewChangeObserver
{
  ...
  */
  ...
  /**
   * Subscribes a single listener to the stream for the specified sources
   */
  @Override
 ...
 throws DatabusClientException
 {
  ...
  throws DatabusClientException
  {
    ...
    try
    {
      ...
      */
      ...
      DbusEventBuffer bootstrapBuffer = new DbusEventBuffer(connConfig.getEventBuffer(), pp);
    ...
    throws InterruptedException
  {
      ...
      if ( partitionId < 0 )
      {
        LOG.error("Partition Number for registration :" + reg + " is invalid !!");
      ...
      {
        LOG.error("External view for this registration is empty !! Cannot obtain Max SCN");
