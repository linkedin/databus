...
public class SimpleFileLoggingConsumer {
  ...
  public void mainFunction(String args[]) throws Exception
  {
    ...
    List<String> sources = addSources();
    ...
    client.registerDatabusStreamListener(logConsumer, sources, filterConfig);
    ...
    client.registerDatabusStreamListener(consumer, sources, filterConfig);
    if (_enableBootStrap)
    {
      client.registerDatabusBootstrapListener(logConsumer, sources, filterConfig);
      client.registerDatabusBootstrapListener(consumer, sources, filterConfig);
    }
