...
The slides for the presentation are available [here](http://www.slideshare.net/ShirshankaDas/databus-socc-2012)

# How to build ?

Databus requires a library distributed by Oracle Inc under Oracle Technology Network License. Please accept that license at 
http://www.oracle.com/technetwork/licenses/distribution-license-152002.html, and download ojdbc6.jar, with version at 11.2.0.2.0
The link to download is http://www.oracle.com/technetwork/database/enterprise-edition/jdbc-112010-090769.html 

Databus will *NOT* build without this step. Due to licensing restrictions, we are *NOT* able to provide this jar in this repo.
After downloading the jars, they may be copied under :
