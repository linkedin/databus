...
public abstract class DtailPrinter extends AbstractDatabusCombinedConsumer
{
  ...
  public abstract ConsumerCallbackResult printEvent(DbusEvent e, DbusEventDecoder eventDecoder);

  protected ConsumerCallbackResult processEvent(DbusEvent e, DbusEventDecoder eventDecoder)
  {
